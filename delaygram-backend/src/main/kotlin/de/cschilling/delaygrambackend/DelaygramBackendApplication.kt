...
class DelaygramBackendApplication(
    ...
    override fun run(vararg args: String?) {
        ...
        val user2 = User(
            ...
            "user1@example.com",
            null,
            mutableListOf(postRepository.save(Post("Das ist der erste User1 Post", Base64.getDecoder().decode(picture),
                setOf("test1","test2")))),
            0,
            mutableSetOf()
        )
        ...
        val post1 = Post("Das ist der erste Admin Post",Base64.getDecoder().decode(picture), setOf("test1","test2"))
        val post2 = Post("Das ist der zweite User1 Post",Base64.getDecoder().decode(pic2), setOf("test1"))
        val post3 = Post("Das ist der erste User2 Post",Base64.getDecoder().decode(picture), setOf("test1"))
